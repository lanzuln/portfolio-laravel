        ...
        <div class="col-lg-6">
          <div class="card card-large-icons">
            ...
            <div class="card-body">
              ...
              <a href="{{route('general-setting.index')}}" class="card-cta">Change Setting <i class="fas fa-chevron-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="card card-large-icons">
            ...
            <div class="card-body">
              ...
              <a href="{{route('seo-setting.index')}}" class="card-cta">Change Setting <i class="fas fa-chevron-right"></i></a>
            </div>
          </div>
        </div>
      </div>
