        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <figure class="image-block">
                    <img src="{{asset($portfolioDetails->image)}}" alt="">
                </figure>
                <div class="portflio-info">
                    <div class="single-info">
                        <h4 class="title">Client</h4>
                        <p>{{$portfolioDetails->client}}</p>
                    </div>
                    <div class="single-info">
                        <h4 class="title">Date</h4>
                        <p>{{date('d,M,Y', strtotime($portfolioDetails->created_at))}}</p>
                    </div>
                    <div class="single-info">
                        <h4 class="title">Website</h4>
                        <p><a href="{{$portfolioDetails->website}}">{{$portfolioDetails->website}}</a></p>
                    </div>
                    <div class="single-info">
                        <h4 class="title">Role</h4>
                        <p>{{$portfolioDetails->category->name}}</p>
                    </div>
                </div>
