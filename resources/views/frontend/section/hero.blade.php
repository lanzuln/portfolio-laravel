<header class="header-area parallax-bg" id="home-page"
    style="background: url('{{ asset($hero->background) }}')no-repeat scroll top center/cover">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="header-text">
                    ...
                    @if ($hero->btn_text)
                        <a href="{{ $hero->link }}" class="button-dark mouse-dir wow fadeInUp"
