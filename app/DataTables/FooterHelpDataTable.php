...
class FooterHelpDataTable extends DataTable
{
    /**
     ...
     */
    public function query(FooterHelp $model): QueryBuilder
    {
    ...
    {
        return 'FooterHelp_' . date('YmdHis');
    }
}
